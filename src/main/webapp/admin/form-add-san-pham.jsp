...
<body class="app sidebar-mini rtl">
  ...
  <header class="app-header">
    ...
    <ul class="app-nav">
      ...
      <!-- User Menu-->
      <li><a class="app-nav__item" href="form-add-san-pham.jsp"><i class='bx bx-log-out bx-rotate-180'></i> </a>
            ...
            <form class="row">
              ...
              <div class="form-group col-md-3 ">
                ...
                <select class="form-control" id="exampleSelect12">
                  ...
                  <option>Còn sản xuất</option>
                  <option>Ngưng sản xuất</option>
                  <option>Hết nguyên liệu</option>
                </select>
              </div>
              <div class="form-group col-md-3">
              ...
              <div class="form-group col-md-3 ">
                ...
                <select class="form-control" id="exampleSelect1">
                  ...
                  <option>Chi nhánh quân 1</option>
                  <option>Chi nhánh quân 2</option>
                  <option>Chi nhánh quân 3</option>
                  <option>Chi nhánh quân 4</option>
