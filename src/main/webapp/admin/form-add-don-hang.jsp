...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <header class="app-header">
    ...
    <ul class="app-nav">
      ...
      <!-- User Menu-->
      <li><a class="app-nav__item" href="form-add-don-hang.jsp"><i class='bx bx-log-out bx-rotate-180'></i> </a>
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              <form class="row">
                ...
                <div class="form-group  col-md-4">
                  <label class="control-label">Email khách hàng(không bắt buộc)</label>
                  <input class="form-control" type="text" >
                </div>
                <div class="form-group col-md-4">
                  <label for="exampleSelect1" class="control-label">Phương tiện đặt hàng</label>
                ...
                <div class="form-group  col-md-4">
                  <label class="control-label">Ngày xuất đơn hàng</label>
