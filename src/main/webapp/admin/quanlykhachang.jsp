...
<header class="app-header">
  ...
  <ul class="app-nav">
    ...
    <!-- User Menu-->
    <li><a class="app-nav__item" href="quanlykhachang.jsp"><i class='bx bx-log-out bx-rotate-180'></i> </a>
...
<main class="app-content">
  <div class="app-title">
    <ul class="app-breadcrumb breadcrumb side">
      <li class="breadcrumb-item active"><a href="quanlykhachang.jsp"><b>Quản lý Khách hàng</b></a></li>
    </ul>
    <div id="clock"></div>
  </div>
  <div class="row">
        ...
        <div class="tile-body">
          <div class="row element-button">
            <div class="col-sm-2">
              ...
              <a class="btn btn-add btn-sm" href="form-add-bi-cam-khachhang.jsp" title="Thêm"><i class="fas fa-plus"></i>
                Tạo mới</a>
            </div>
            <div class="col-sm-2">
          ...
          <table class="table table-hover table-bordered" id="sampleTable">
            ...
            <tr>
              ...
              <td>Trần Thị Yến Nhi</td>
              <td>kh001</td>
              <td>0917264837</td>
              <td>12/2/2023</td>
              <td>Bánh kem</td>
              <td>80</td>
              <td><span class="badge bg-danger1">Không vi phạm</span></td>
              <td><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"><i class="fas fa-trash-alt"></i></button>
                <button class="btn btn-primary btn-sm edit" type="button" title="Sửa"><i class="fa fa-edit"></i></button></td>
            </tr>
            <tr>
              <td width="10"><input type="checkbox" name="check1" value="1"></td>
              <td>Trần Thị Huyền</td>
              <td>kh002</td>
              <td>0817263997</td>
              <td>1/7/2023</td>
              <td>Bánh Ngọt</td>
            ...
            <tr>
              <td width="10"><input type="checkbox" name="check1" value="1"></td>
              <td>Quế Thanh Ngoan</td>
              <td>kh004</td>
              <td>017284693</td>
              <td>11/2/2023</td>
              <td>Bánh tráng miệng</td>
              <td>80</td>
              <td><span class="badge bg-danger1">Không vi phạm</span></td>
              <td><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"><i class="fas fa-trash-alt"></i></button>
                <button class="btn btn-primary btn-sm edit" type="button" title="Sửa"><i class="fa fa-edit"></i></button></td>
