...
<header class="app-header">
  ...
  <ul class="app-nav">
    ...
    <!-- User Menu-->
    <li><a class="app-nav__item" href="table-data-oder.jsp"><i class='bx bx-log-out bx-rotate-180'></i> </a>
        ...
        <div class="tile-body">
          ...
          <table class="table table-hover table-bordered" id="sampleTable">
            ...
            <tr>
              ...
              <td>MD0837</td>
              <td>Triệu Thanh Phong</td>
              <td>Bánh kem hương socola, Bánh kem thạch</td>
              <td>2</td>
              <td>300.000 đ</td>
            ...
            <tr>
              <td width="10"><input type="checkbox" name="check1" value="1"></td>
              <td>MT9835</td>
              <td>Đặng Hoàng Long</td>
              <td>Bánh con sò, Bánh su kem, Bánh dâu trà xanh, Bánh mức dâu</td>
              <td>4 </td>
              <td>600.000 đ</td>
              <td><span class="badge bg-success">Hoàn thành</span></td>
              <td><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"><i class="fas fa-trash-alt"></i> </button>
            ...
            <tr>
              <td width="10"><input type="checkbox" name="check1" value="1"></td>
              <td>ER3835</td>
              <td>Nguyễn Thị Mỹ Dung</td>
              <td>Bánh bông lan việt quốc, Bánh kem trứng</td>
              <td>2 </td>
              <td>300.000 đ</td>
            ...
            <tr>
              <td width="10"><input type="checkbox" name="check1" value="1"></td>
              <td>AL3947</td>
              <td>Phạm Thị Ngọc Lan</td>
              <td>Bánh kem cacao, Bánh kem chà bông</td>
              <td>2 </td>
              <td>300.000 đ</td>
            ...
            <tr>
              <td width="10"><input type="checkbox" name="check1" value="1"></td>
              <td>QY8723</td>
              <td>Ngô Thái Thành</td>
              <td>Bánh kem dâu tình yêu</td>
              <td>1 </td>
              <td>250.000 đ</td>
