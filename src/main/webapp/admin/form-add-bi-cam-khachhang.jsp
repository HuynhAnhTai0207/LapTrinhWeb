...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <header class="app-header">
    ...
    <ul class="app-nav">
      ...
      <!-- User Menu-->
      <li><a class="app-nav__item" href="form-add-bi-cam-khachhang.jsp"><i class='bx bx-log-out bx-rotate-180'></i> </a>
  ...
  <aside class="app-sidebar">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Tạo mới danh sách khách hàng</h3>
            <div class="tile-body">
