...
<header class="app-header">
  ...
  <ul class="app-nav">
    ...
    <!-- User Menu-->
    <li><a class="app-nav__item" href="table-data-banned.jsp"><i class='bx bx-log-out bx-rotate-180'></i> </a>
        ...
        <div class="tile-body">
          ...
          <table class="table table-hover table-bordered" id="sampleTable">
            ...
            <tr>
              ...
              <td>10/09/2002</td>
              <td>Bán hàng</td>
              <td>Gian lận trong công việc đã lấy trộm tiền của Cửa hàng và thái độ không ăn năn hối lỗi.</td>
            ...
            <tr>
              <td width="10"><input type="checkbox" name="check1" value="1"></td>
              <td>Võ Thành Trung</td>
              <td>19/09/2004</td>
              <td>Làm bánh</td>
              <td>Phá hỏng 9 sản phẩm của Cửa hàng, có kháng cự khi bị bắt (bồi thường 5.000.000 đ)</td>
              <td><span class="badge bg-danger">Sa thải</span></td>
              <td><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"><i class="fas fa-trash-alt"></i></button>
                <button class="btn btn-primary btn-sm edit" type="button" title="Sửa"><i class="fa fa-edit"></i></button></td>
            </tr>
