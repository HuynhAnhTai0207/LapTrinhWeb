        ...
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    ...
                    <form action="${pageContext.request.contextPath}/admin-edit-san-pham" method="post" class="row">
                        <div class="form-group col-md-3">
                            <label class="control-label">ID sản phẩm</label>
                            <input name="id"  value="${ProductId.id_Product}" class="form-control" type="text">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Tên sản phẩm</label>
                            <input name="name" value="${ProductId.name}" class="form-control" type="text">
                        </div>
                        <div class="form-group  col-md-3">
                            <label class="control-label">Số lượng</label>
                            <input name="quantity" value="${ProductId.quantity}" class="form-control" type="number">
                        </div>
                        <div class="form-group col-md-3 ">
                            <label class="control-label">Bánh mới</label>
                            <select name="isNew" class="form-control">
                                <option>Bánh mới</option>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input name="catalog" value="${ProductId.category}" class="form-control" type="text">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Giá bán</label>
                            <input name="primeCost" value="${ProductId.price}" class="form-control" type="number">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Giá vốn</label>
                            <input name="price" value="${ProductId.price_buy}" class="form-control" type="number">
                        </div>
                        <div class="form-group col-md-12">
                            <label class="control-label">Mô tả sản phẩm</label>
                            <textarea class="form-control" value="${ProductId.detail}" name="description"></textarea>
                        </div>
