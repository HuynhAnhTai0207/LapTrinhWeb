...
<%--                <td><span class="badge bg-success">${product.status}</span></td>--%>
                ...
                <td>
                    <button class="btn btn-primary btn-sm trash" type="button" title="Xóa"
                            onclick="confirmDeleteProduct('${product.id_Product}')"><i class="fas fa-trash-alt"></i>
                    </button>
                    <a href="${pageContext.request.contextPath}/admin-edit-san-pham?id=${product.id_Product}">
      ...
      dangerMode: true,
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                window.location.href = '/admin-delete-san-pham?id='+id
              } else {
                swal("Đã hủy!");
              }
            });
