...
<head>
  ...
  <link  rel="icon" href="img/Title/water (1).png">
  <meta charset="utf-8">
...
<header class="app-header">
  ...
  <ul class="app-nav">
    ...
    <!-- User Menu-->
    <li><a class="app-nav__item" href="table-data-table.jsp"><i class='bx bx-log-out bx-rotate-180'></i> </a>
        ...
        <div class="tile-body">
          ...
          <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
              ...
              <td>#St20130410</td>
              <td>Nguyễn Võ Trường Thạnh</td>
              <td><img class="img-card-person" src="../img/u1.jpg" alt=""></td>
              <td>Khu phố 6, Tp.Thủ Đức,Tp.Hồ Chí Minh </td>
              <td>7/12/2002</td>
              <td>Nam</td>
              <td>*********</td>
              <td>Nhân viên</td>
