...
<header class="app-header">
    ...
    <ul class="app-nav">
        ...
        <!-- User Menu-->
        <li><a class="app-nav__item" href="quan-ly-bao-cao.jsp"><i class='bx bx-log-out bx-rotate-180'></i> </a>
            ...
            <div class="tile">
                ...
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tr>
                            <td>71309005</td>
                            <td>Bánh kem dâu tây</td>
                            <td>150.000 đ</td>
                            <td>Bánh kem</td>
                        </tr>
                        <tr>
                            <td>62304003</td>
                            <td>Bánh kem trái cây</td>
                            <td>150.000 đ</td>
                            <td>Bánh kem</td>
                        </tr>
                        <tr>
                            <td>72109004</td>
                            <td>Bánh kem phô mai bắp</td>
                            <td>30.000 đ</td>
                            <td>Bánh kem</td>
                        </tr>
                        <tr>
                ...
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tr>
                            ...
                            <td>Bánh kem trứng, Bánh bông lan sữa</td>
                            <td>2 sản phẩm</td>
                            <td>300.000 đ</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>Bánh kem cam, Bánh mức dâu, Bánh con sò</td>
                            <td>3 sản phẩm</td>
                            <td>450.000 đ</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>AL3947</td>
                            <td>Phạm Thị Ngọc</td>
                            <td>Bánh kem Ý socola, Bánh kem bơ</td>
                            <td>2 sản phẩm</td>
                            <td>450.000 đ</td>
                        </tr>
                        <tr>
                ...
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tr>
                            ...
                            <td>232 Trần Quốc Thảo, Quận 3, Hồ Chí Minh </td>
                            <td>12/02/2001</td>
                            <td>Nữ</td>
                            <td>0926737167</td>
                            <td>Bán hàng</td>
                        ...
                        <tr>
                            <td>Trần Khả Như</td>
                            <td>12 Nguyễn Lương Bằng, Tân Phú, Quận 7, Hồ Chí Minh</td>
                            <td>22/12/2002</td>
                            <td>Nữ</td>
                            <td>0931342432</td>
                            <td>Thu ngân</td>
                        ...
                        <tr>
                            <td>Nguyễn Đặng Trọng Phúc</td>
                            <td>22C Nguyễn Đình Chiểu, Quận 3, Hồ Chí Minh </td>
                            <td>23/07/2003</td>
                            <td>Nam</td>
                            <td>0846881155</td>
                            <td>Bán hàng</td>
