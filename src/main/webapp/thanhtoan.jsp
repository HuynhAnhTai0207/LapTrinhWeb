                		...
                		<div class="billing_form_area">
                			<form class="billing_form row" action="http://galaxyanalytics.net/demos/cake/theme/cake-html/contact_process.php" method="post" id="contactForm" novalidate="novalidate">
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control" id="first" name="name" placeholder="Tên của bạn">
								</div>
								<div class="form-group col-md-6">
								...
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" id="city" name="city" placeholder="Thị trấn / Thành phố">
								</div>
								<div class="form-group col-md-6">
								    <label for="state1">Tiểu bang / Quốc gia *</label>
									<select class="product_select" id="state1">
                                        <option data-display="Select an option">Chọn Tiểu bang / Quốc gia</option>
								...
								<div class="form-group col-md-6">
								    <label for="zip">Mã code / Mã zip *</label>
									<input type="text" class="form-control" id="zip" name="zip" placeholder="Mã code / Mã zip">
								</div>
								<div class="form-group col-md-6">
								...
								<div class="select_check2 col-md-12">
									<div class="creat_account">
										...
										<label for="f-option2">Gửi đến một địa chỉ khác?</label>
										<div class="check"></div>
									</div>
								</div>
								<div class="form-group col-md-12">
									<label for="phone">Ghi chú đặt hàng</label>
									<textarea class="form-control" name="message" id="message" rows="1" placeholder="Lưu ý về đơn đặt hàng của bạn. ví dụ. lưu ý đặc biệt khi giao hàng"></textarea>
								</div>
							</form>
                		</div>
                	</div>
                		...
                		<div class="order_box_price">
							...
							<div class="payment_list">
								<div class="price_single_cost">
									...
									<h5>Bánh sinh nhật dâu <span>150000VNĐ</span></h5>
									<h4>Tổng phụ <span>150000VNĐ</span></h4>
									<h5>Vận chuyển và xử lý<span class="text_f">Miễn phí vận chuyển</span></h5>
									<h3>Tổng cộng <span>150000VNĐ</span></h3>
								</div>
