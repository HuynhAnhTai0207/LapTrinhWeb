	...
	<div class="container">
		<div class="table-responsive">
			<table class="table">
				...
				<tbody>
				<% List<OrderDetail> orderDetails = (List<OrderDetail>) request.getSession().getAttribute("orderDetails");
				...
				%>
				<tr>
					<td colspan="6">Đơn hàng trống</td>
				</tr>
				<%
					}
				%>
				<tr>
					...
					<td></td>
					<td>
						<a class="pest_btn" href="lich-su-don-hang">Trở lại</a>
					</td>
				</tr>
				</tbody>
			</table>
