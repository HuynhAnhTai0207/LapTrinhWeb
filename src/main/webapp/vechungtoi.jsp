		...
		<section class="our_bakery_area p_100">
			<div class="container">
				<div class="our_bakery_text">
					...
					<h6>Chắc chắn là một vai diễn thú vị! Đầu tiên, chào mừng bạn đến tiệm bánh của tôi, nơi mà mọi chiếc bánh sinh nhật trở nên đặc biệt! Tôi là chủ tiệm, và tôi sẽ hướng dẫn bạn qua một số bước cơ bản để tạo ra những tác phẩm nghệ thuật ẩm thực này.</h6>
					<p>Chúng ta sẽ cần những nguyên liệu chất lượng cao. Bột mỳ, đường, trứng, và đừng quên bơ, vì bơ là chìa khóa để có được độ mềm mịn cho bánh. Sau khi có đủ nguyên liệu, bắt đầu bằng cách trộn chúng thật kỹ để tạo ra hỗn hợp mịn màng.Lựa chọn hình dạng và kích thước cho chiếc bánh của bạn. Có thể bạn muốn một chiếc bánh tròn lớn cho bữa tiệc hoặc các chiếc bánh nhỏ hơn để phục vụ từng người một cách cá nhân.</p>
				</div>
		...
		<section class="bakery_video_area">
			<div class="container">
				<div class="video_inner">
					<h3>Hương vị thực sự</h3>
					<p>Bột mì chua nhẹ với quả óc chó nướng và hương thảo mới hái, húng tây, hạt anh túc, rau mùi tây và cây xô thơm.</p>
					<div class="media">
						<div class="d-flex">
							<a class="popup-youtube" href="http://www.youtube.com/watch?v=0O2aH4XLbto"><i class="flaticon-play-button"></i></a>
						</div>
						<div class="media-body">
							<h5>Xem video giới thiệu <br />Về chúng tôi</h5>
						</div>
					</div>
				</div>
			</div>
        		...
        		<div class="row our_mission_inner">
        			...
        			<div class="col-lg-9">
        				<div class="mission_inner_text">
        					<h6>Để hài lòng khách hàng khi bán bánh sinh nhật, quan trọng nhất là chăm sóc cảm xúc và chất lượng sản phẩm. Đảm bảo rằng bánh của bạn ngon miệng và đẹp mắt. </h6>
        					<p>Ngoài ra, tạo trải nghiệm mua sắm tốt bằng cách cung cấp dịch vụ khách hàng xuất sắc, lắng nghe phản hồi của họ và đảm bảo giao hàng đúng hẹn và an toàn. Bạn cũng có thể thêm vào đó những ưu đãi đặc biệt, như gói quà hoặc dịch vụ làm bánh tận nơi. Điều này sẽ giúp tạo ra trải nghiệm không chỉ là việc mua sắm, mà còn là một kỷ niệm đáng nhớ.</p>
        					<ul class="nav">
        						<li><a href="cake.jsp">Bánh theo yêu cầu</a></li>
        						<li><a href="cake.jsp">Bánh sinh nhật</a></li>
        						<li><a href="cake.jsp">Bánh đám cưới</a></li>
        						<li><a href="cake.jsp">Món ngon châu âu</a></li>
        					</ul>
        				</div>
        			</div>
        		</div>
