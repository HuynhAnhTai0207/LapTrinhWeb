        ...
        <section class="service_offer_area p_100">
        	<div class="container">
        		<div class="main_title">
        			<h2>Những gì chúng tôi làm</h2>
        			<p> Những điều này đến từ người sáng tạo chân thật và như kiến trúc sư của cuộc sống, họ đã tạo ra một cuộc sống đẹp như một tác phẩm nghệ thuật.</p>
        		</div>
        			...
        			<div class="col-lg-4 col-sm-6">
        				<div class="service_m_item">
        					...
        					<div class="service_text">
        						<a href="#"><h4>Bánh sinh nhật dâu</h4></a>
        					</div>
        				</div>
        			</div>
        			<div class="col-lg-4 col-sm-6">
