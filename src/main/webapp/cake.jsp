        ...
        <section class="our_cakes_area p_100">
        	<div class="container">
        		<div class="main_title">
        			<h2>Danh mục bánh có sẳn</h2>
        			<h5>Bánh có sẳn tại cửa hàng, luôn liên tục ra lò nên hương vị 100% nguyên bản</h5>
        		</div>
