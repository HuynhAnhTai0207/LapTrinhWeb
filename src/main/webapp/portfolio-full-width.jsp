        ...
        <section class="banner_area">
        	<div class="container">
        		<div class="banner_text">
        			...
        			<ul>
        				<li><a href="trangchu.jsp">Trang chủ</a></li>
        				<li><a href="portfolio.jsp">Danh mục đầu tư</a></li>
        			</ul>
        		</div>
        	</div>
        </section>
        ...
        <section class="portfolio_area portfolio_full p_100">
			<div class="portfolio_filter">
				<ul class="list_style">
					...
					<li data-filter=".cake"><a href="#">Bánh</a></li>
					<li data-filter=".bakery"><a href="#">Cửa hàng Bánh Mì</a></li>
					<li data-filter=".past"><a href="#">Bánh ngọt</a></li>
					<li data-filter=".choco"><a href="#">Sôcôla</a></li>
					<li data-filter=".bread"><a href="#">Bánh mì</a></li>
			...
			<div class="portfolio_full_width_area grid_portfolio_area imageGallery1">
				...
				<div class="portfolio_full_item cake past">
					<div class="portfolio_item">
						...
						<div class="portfolio_text">
							<a href="#"><h4>Bánh bông lan kem</h4></a>
						</div>
					</div>
				</div>
